...
import 'bus_home_model.dart';
export 'bus_home_model.dart';

class BusHomeWidget extends StatefulWidget {
  const BusHomeWidget({Key? key}) : super(key: key);

  @override
  _BusHomeWidgetState createState() => _BusHomeWidgetState();
}

class _BusHomeWidgetState extends State<BusHomeWidget> {
  late BusHomeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BusHomeModel());
                                ...
                                child: PagedListView<DocumentSnapshot<Object?>?,
                                  ...
                                  pagingController: () {
                                    ...
                                    if (_model.pagingController != null) {
                                      final query =
                                          queryBuilder(BusRecord.collection);
                                    ...
                                    _model.pagingController!
                                        .addPageRequestListener(
                                            (nextPageMarker) {
                                      queryBusRecordPage(
                                        queryBuilder: (busRecord) => busRecord,
                                  ...
                                  builderDelegate:
                                      PagedChildBuilderDelegate<BusRecord>(
                                    ...
                                    itemBuilder:
                                      ...
                                      final mainlistviewBusRecord = _model
                                          .pagingController!
                                          .itemList![mainlistviewIndex];
                                      return Container(
                                        width: 390.0,
                                        height: 210.0,
                                        decoration: BoxDecoration(
