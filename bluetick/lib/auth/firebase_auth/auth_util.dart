...
DocumentReference? get currentUserReference =>
    loggedIn ? UserloginRecord.collection.doc(currentUser!.uid) : null;

UserloginRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserloginRecord.getDocument(UserloginRecord.collection.doc(uid))
              .handleError((_) {}),
    )
