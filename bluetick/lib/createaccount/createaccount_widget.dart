                        ...
                        children: [
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              final userloginCreateData =
                                  createUserloginRecordData(
                                userName: _model.emailAddressController1.text,
                                phoneNumber:
                                    _model.emailAddressController2.text,
                                email: _model.emailAddressController3.text,
                              );
                              await UserloginRecord.collection
                                  .doc(user.uid)
                                  .update(userloginCreateData);

                              await authManager.sendEmailVerification();

                              context.pushNamedAuth('authpage', mounted);
